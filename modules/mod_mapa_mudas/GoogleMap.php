...
class GoogleMapAPI {
     ...
     */
    var $dsn = null;
    var $api_key = 'AIzaSyDtibuq-WR0XC5KJRpI-zsO0Cpt7omeFHc';
    var $api_ver = '';
     ...
     */
    function setMarkerIcon($iconImage,$iconShadow = '',$iconAnchorX = 'x',$iconAnchorY = 'x',$infoWindowAnchorX = 'x',$infoWindowAnchorY = 'x') {
        $this->default_icon = $iconImage;
        $this->default_icon_shadow = $iconShadow;
    ...
    function getHeaderJS() {
        ...
        $_headerJS = "
            $_mobile_meta
            <script type='text/javascript' src='https://maps.google.com/maps/api/js?key=AIzaSyBJa8_7yD-_h9oRc7MlVbIRrpL15HeVve8'></script>
        ";
